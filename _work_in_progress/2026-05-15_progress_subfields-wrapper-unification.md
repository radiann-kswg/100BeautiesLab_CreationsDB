...
- 変更点の要約: 今後の再利用向けに `.github/copilot-instructions.md` / `docs/wrapper-summary-registry.md` / `docs/implementation-playbook.md` を整理し、main code と subscript の責務分離、subField 折りたたみ規則、`hideText` が UI wrapper を変えない方針、subscript 注釈ルールを明文化した
