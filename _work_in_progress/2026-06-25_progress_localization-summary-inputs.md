...
ファイル: `data/Localization/trans_Dict.json`

地名は複数作品にまたがる設定の起点になるため、最初に揃えると後続エントリに一貫性が出る。

| 状態 | Term_JP | Term_EN | Scope（主な登場） |
| ---- | ------- | ------- | --------------- |
| [ ] | 九蓮国 | LotusNinea | NT / FL78 / UnauthedLogica / UnibyteLive |
...
ファイル: `data/Works_DestinyFoxRecords/Localization/trans_Dict.json`
...
ファイル: `data/Works_ShouArRiders/Localization/trans_Dict.json`
...
ファイル: `data/Works_FLInvestigator78/Localization/trans_Dict.json`
