...
class TypeDefUtils {
  ...
  static pickDisplaySection(entry) {
    ...
    if (typeStr.includes('#Summary') || typeStr.includes('#Dialogue') || /(Calling|Character|Hobby|SpetialSkill|Favor|Unlike|About|Comment|Summary|Dialogue)/i.test(key)) return 'profile';
