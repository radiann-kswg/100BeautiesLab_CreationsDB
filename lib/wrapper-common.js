...
(function initializeCharacterValueWrapperRegistry(root) {
  ...
  function formatEraSummary(point, context) {
    ...
    const about = pickAboutText(
      ...
      ?? (_eraLang === 'en' ? (point.about_EN ?? point.about_JP) : (point.about_JP ?? point.about_EN))
      ?? point.about
    );
  ...
  function formatStoryEraCatalog(value, context) {
    ...
    const about = pickAboutText(
      ...
      ?? (_eraLang === 'en' ? (value.about_EN ?? value.about_JP) : (value.about_JP ?? value.about_EN))
      ?? value.about
    );
    if (about) return about;
  ...
  function formatDaySummary(value, context) {
    ...
    const aboutValue = pickRoleRawValue(value, typeSources, '$Def_Day', 'annotation')
      ?? (_dayLang === 'en' ? (value.DayAbout_EN ?? value.DayAbout_JP) : (value.DayAbout_JP ?? value.DayAbout_EN))
      ?? (_dayLang === 'en' ? (value.about_EN ?? value.about_JP) : (value.about_JP ?? value.about_EN))
      ?? value.about;
