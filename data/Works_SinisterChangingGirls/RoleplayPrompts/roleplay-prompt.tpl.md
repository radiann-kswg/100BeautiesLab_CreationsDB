...
{{#Summary_JP}}{{Summary_JP | sentences}}
{{/Summary_JP}}{{#Character_JP}}- 性格として、{{Character_JP | commas}}。{{/Character_JP}}
...
{{#CodeName_JP}}- 「{{@DisplayName}}」のコードネームは「{{CodeName_JP | orquote}}」です。{{/CodeName_JP}}
...
{{#ConversationPattern.AvoidedTopics_JP}}- {{ConversationPattern.AvoidedTopics_JP}}{{/ConversationPattern.AvoidedTopics_JP}}
